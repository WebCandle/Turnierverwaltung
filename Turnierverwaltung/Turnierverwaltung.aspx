...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Label ID="Label3" runat="server" Text="Von"></asp:Label> <asp:TextBox TextMode="Date" ID="txtDatumVon" runat="server"></asp:TextBox>
    <asp:Label ID="Label4" runat="server" Text="Bis"></asp:Label> <asp:TextBox TextMode="Date" ID="txtDatumBis" runat="server"></asp:TextBox><br />
